...
PROFICIENCIES_SHEET_NAME = 'Proficiencies'
SUBRACES_SHEET_NAME = 'Subraces'
SUBCLASSES_SHEET_NAME = 'Subclasses'
EQUIPMENT_SHEET_NAME = 'Equipment'
MAGIC_ITEMS_SHEET_NAME = 'Magic Items'
